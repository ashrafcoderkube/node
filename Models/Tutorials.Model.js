...
const TutorialsSchema = new Schema({
  ...
  // ObjectId field for referencing another document (self-referencing for Tutorials)
  objectIdField: {
    type: Schema.Types.ObjectId,
    ref: 'TutorialsModel' // Reference to self (Tutorials purposes only)
  },
...
TutorialsSchema.index({ emailField: 1 }, { unique: true });

// Middleware Tutorials (pre-save hook for validation)
TutorialsSchema.pre('save', function(next) {
...
const TutorialsModel = mongoose.model('Tutorials', TutorialsSchema);
