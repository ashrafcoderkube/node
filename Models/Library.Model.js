...
const LibrarySchema = new Schema({
  ...
  // ObjectId field for referencing another document (self-referencing for Library)
  objectIdField: {
    type: Schema.Types.ObjectId,
    ref: 'LibraryModel' // Reference to self (Library purposes only)
  },
...
LibrarySchema.index({ emailField: 1 }, { unique: true });

// Middleware Library (pre-save hook for validation)
