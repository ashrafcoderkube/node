...
const TypeSchema = new Schema({
  ...
  // ObjectId field for referencing another document (self-referencing for Type)
  objectIdField: {
    type: Schema.Types.ObjectId,
    ref: 'TypeModel' // Reference to self (Type purposes only)
  },
...
TypeSchema.index({ emailField: 1 }, { unique: true });

// Middleware Type (pre-save hook for validation)
