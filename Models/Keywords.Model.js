...
const KeywordsSchema = new Schema({
  ...
  // ObjectId field for referencing another document (self-referencing for Keywords)
  objectIdField: {
    type: Schema.Types.ObjectId,
    ref: 'KeywordsModel' // Reference to self (Keywords purposes only)
  },
...
KeywordsSchema.index({ emailField: 1 }, { unique: true });

// Middleware Keywords (pre-save hook for validation)
